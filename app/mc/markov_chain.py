...
class MarkovChain(dict):
    ...
    async def get_available_words(self, frame: Tuple[str, ...]) -> Optional[dict]:
    ...
    async def get_random_available_word(self, frame: Tuple[str, ...]) -> Optional[str]:
    ...
    async def get_full_frame(self, beginning: Tuple[str, ...]) -> Optional[tuple]:
